# ¿Cómo respiras realmente? · Contenido y lógica del test

Test de autoevaluación del **Método Pranamah**. Este documento reúne todo lo que
contiene el test: textos, puntuación, umbrales y reglas. El test funcionando está
en `index.html`, en esta misma carpeta, y los textos de este documento son los
mismos que muestra la página.

---

## 1. Nombre del test

**¿Cómo respiras *realmente*?**

Es más corto que «¿Cómo estás respirando realmente?» y conserva la palabra que
lleva la carga, *realmente*. Esa palabra da por hecho que la persona cree saberlo
y le propone comprobarlo. Va en cursiva, que es la firma tipográfica de la marca.

## 2. Subtítulo

**Descubre en qué punto está tu respiración.**

Se usa en la portada, completado con «…y qué hábitos pueden estar influyendo en
ella», y en la tarjeta que se ve al compartir el enlace.

## 3. Pantalla inicial

```
                         ◯   (círculo que «respira»: 4 s entra, 6 s sale)
   ...
   Respiras miles de veces cada día. Pero… ¿alguna vez
          te has parado a observar cómo lo haces?

   Descubre en menos de 2 minutos en qué punto está tu
   respiración y qué hábitos pueden estar influyendo en ella.

                   [ EMPEZAR TEST ]

             12 preguntas · Resultado al momento
```

En la portada pone «miles de veces» y la cifra concreta, 20.000, se deja para el
CTA final. Así la cifra llega cuando la persona ya se ha observado.

## 4 y 5. Las 12 preguntas y sus respuestas

Todas usan la **misma escala de frecuencia**, sin excepciones:
...
La escala sirve para las 12 preguntas, así que no hay ninguna distinta. En las tres
preguntas de autoobservación (4, 7 y 8), quien no se ha fijado nunca tiende a
responder «Nunca». Eso resta puntos, no los suma: el error va hacia el lado
prudente.

El área de cada pregunta no se enseña durante el test. Encima de cada pregunta
aparece un antetítulo breve que sitúa la escena.

| # | Antetítulo | Pregunta | Pista (una línea, opcional) | Área |
|---|---|---|---|---|
| 1 | La nariz | ¿Notas la nariz tapada o cargada sin tener un resfriado? | Responde pensando en tu día a día, sin corregir nada. | A · Nariz y boca |
| 2 | Sin darte cuenta | Mientras trabajas, lees o ves una serie, ¿te descubres respirando por la boca? | — | A · Nariz y boca |
...
Cada pregunta pasó dos filtros: «¿se responde en 3 segundos sin saber nada de
respiración?» y «¿aporta algo que no digan las demás?».

| Pregunta de partida | Decisión | Por qué |
|---|---|---|
| 1 · Nariz congestionada | **Se queda** (1) | Se añade «sin tener un resfriado» para no puntuar lo que le pasa a todo el mundo en invierno. |
| 2 · Boca porque por la nariz no entra aire | **Fuera** | Mezcla dos variables (boca y nariz insuficiente) y ya la cubren la 1 y la 2. |
...
| 11 · Abrir la boca en esfuerzo moderado | **Se queda** (9) | Es la prueba más clara de si la respiración nasal aguanta en movimiento. |
...
Nunca = 0 · A veces = 1 · A menudo = 2 · Casi siempre = 3. Es igual en las 12
preguntas.

## 7. Puntuación total

Se calculan dos cifras:

- **Total**: la suma de los puntos, de 0 a 36.
- **Frecuentes**: el número de respuestas «A menudo» o «Casi siempre», de 0 a 12.

Con la segunda se cumple el principio de valorar la frecuencia y la combinación.
Diez «A veces» no pesan lo mismo que tres «Casi siempre».

## 8. Umbrales de los 3 niveles

Las reglas se aplican en este orden:

| Nivel | Condición |
|---|---|
| **3 · Merece atención** | Total ≥ 21 **o** frecuentes ≥ 7 |
| **1 · Buena base** | Total ≤ 11 **y** frecuentes ≤ 2 |
| **2 · Hábitos a revisar** | Todo lo demás |

Por qué así:

- **Uno o dos hábitos no te sacan del nivel 1.** Por ejemplo, alguien con la
  nariz siempre cargada que respira por la boca («Casi siempre» en ambas) y
  nada más sigue en nivel 1, y el resultado le señala la nariz como lo que
  merece la pena observar.
- **El nivel 3 exige un patrón repetido y repartido.** Un total de 21 solo se
  alcanza con al menos cinco respuestas frecuentes y señales en tres áreas como
  mínimo. Por eso el texto del nivel 3 puede decir «en más de un área» sin
  equivocarse nunca.
- **Calibración.** En una simulación con respuestas típicas de población
  general (sobre todo «Nunca» y «A veces»), alrededor de la mitad sale en
  nivel 1, la otra mitad en nivel 2 y prácticamente nadie en nivel 3. Con una
  audiencia ya interesada en la respiración predomina el nivel 2, y solo un
...
|---|---|---|---|
| A · Nariz vs. boca | 1, 2, 3 | 9 | Nariz y boca |
...
1. Para cada área se calcula la **proporción**: puntos del área divididos entre
   su máximo. Así un área de 2 preguntas y otra de 3 se comparan en igualdad.
2. Un área **destaca** si su media pasa de «A veces», es decir, si tiene más
...
El resultado incluye además **«Tu mapa respiratorio»**: cinco barras finas, sin
números. La barra del área predominante va en azul noche y las demás en arena.
Hace que el resultado se perciba como propio sin parecer un informe clínico.

## 10. Texto completo de los 3 resultados
...
Antetítulo del bloque de área: **Lo que merece la pena observar**
...
>
> La buena noticia: los patrones respiratorios se pueden entrenar.

Antetítulo del bloque de área: **Dónde se nota más**

### Nivel 3 · Merece atención

> **Tu respiración merece más *atención***
>
> Aparecen varias señales frecuentes, y en más de un área. No es un diagnóstico
> ni significa que tengas una enfermedad.
>
> Sí indica que merece la pena observar y evaluar tu patrón respiratorio con más
> detalle, porque puede estar influyendo en cómo te sientes cada día.
...
Es un bloque en azul noche, la única pieza en negativo de todo el test.

> EL SIGUIENTE PASO
>
> **Respiras unas 20.000 veces al día y, probablemente, nadie te ha enseñado a
> *observar* cómo lo haces.**
>
...
- **Nivel 1:** Tienes una buena base, y eso es justo lo que permite afinar:
  aprender a observar tu respiración y a mantenerla tranquila también cuando el
  día se complica.
- **Nivel 2:** Ahora que sabes qué puede estar ocurriendo, el siguiente paso no
  es intentar respirar perfecto. Es reeducar poco a poco esos hábitos hasta que
  respirar bien vuelva a ser lo automático.
- **Nivel 3:** Lo que has descubierto hoy no se resuelve forzando respiraciones
...
14 respiraciones por minuto: es una cifra redonda y prudente, y por eso va con
«unas». Si se quiere la versión más conservadora posible: «más de 17.000 veces
al día».
...
barras, opción elegida), gris solo en líneas finas y sin rosa. Una palabra en
...
- **Accesibilidad:** las opciones son un grupo de radio. Los cambios de pregunta
  ...
  movimiento.
- **Comprobar un caso desde la consola del navegador:**
  `PranamahTest.evaluar([0,1,2,0,1,1,2,0,1,0,2,3])` devuelve el total, las
  frecuentes, el nivel y el área predominante.
- **Editar textos:** todo está al principio del `<script>` de `index.html`, en
  `AREAS`, `SIN_AREA`, `PREGUNTAS`, `NIVELES` y `UMBRALES`.
